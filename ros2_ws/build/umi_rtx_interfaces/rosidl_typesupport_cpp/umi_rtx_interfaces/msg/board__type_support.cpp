...
static const _Board_type_support_symbol_names_t _Board_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, umi_rtx_interfaces, msg, Board)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, umi_rtx_interfaces, msg, Board)),
  }
};
...
{
  return &::umi_rtx_interfaces::msg::rosidl_typesupport_cpp::Board_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, umi_rtx_interfaces, msg, Board)() {
  return get_message_type_support_handle<umi_rtx_interfaces::msg::Board>();
}
