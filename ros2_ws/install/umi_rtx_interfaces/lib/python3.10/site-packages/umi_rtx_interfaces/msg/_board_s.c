...
bool umi_rtx_interfaces__msg__board__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("umi_rtx_interfaces.msg._board.Board", full_classname_dest, 35) == 0);
  }
  umi_rtx_interfaces__msg__Board * ros_message = _ros_message;
  {  // data
...
PyObject * umi_rtx_interfaces__msg__board__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("umi_rtx_interfaces.msg._board");
  ...
  {  // data
    ...
    memcpy(dst, src, 9 * sizeof(int32_t));
    Py_DECREF(field);
  }
