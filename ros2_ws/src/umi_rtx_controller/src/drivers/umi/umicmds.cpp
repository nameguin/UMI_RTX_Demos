...
#include "umi_rtx_controller/umi-drivers/rtxcmds.h"
#include "umi_rtx_controller/robotics/umi.h"
#include "umi_rtx_controller/robotics/umiinit.h"
...
#else
#define Name_File "../umi-rtx/data/name_file"
#endif
...
void umi_init()
{
        ...
        //         cout << 2 << endl;
        //         if(!(stat & (RESP_MASK_ERR_LIMITS | RESP_MASK_AXIS_RESET | RESP_MASK_USER_IO_CONF) )) {
        //                 if(1) {
        //                         cout << "RTX ready to use" << endl;
        //                 }
        //                 initiation_ready = 1;
        //                 return;
        //         }
	...
	/*
        ...
        cout << ("U.M.I. RTX Robot Arm") << endl;
        cout << ("====================") << endl;
        cout << ("Initialisation Program") << endl;
        /*
...
void umi_move(double zed, double shoulder, double elbow, double yaw, double pitch, double roll, double gripper)
{
